  ...
  return (
    <div className="font-body">
      ...
      <div className="border-b border-[var(--hairline)]/60 py-14 sm:py-16">
        <Section>
          <h1 className="font-display text-4xl/tight sm:text-5xl/tight font-semibold tracking-tight text-brand-ink">
            About COTTO
          </h1>
        </Section>
      </div>
      ...
      <Section className="py-10 sm:py-14">
        <h2 className="font-display text-2xl font-semibold tracking-tight text-brand-ink mb-8">
          What makes COTTO special
        </h2>
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          <div className="rounded-2xl border border-neutral-200/70 bg-white p-6 shadow-[0_1px_0_rgba(0,0,0,0.04)]">
            <h3 className="font-display text-lg font-semibold text-brand-ink mb-3">Clean ingredients</h3>
          ...
          <div className="rounded-2xl border border-neutral-200/70 bg-white p-6 shadow-[0_1px_0_rgba(0,0,0,0.04)]">
            <h3 className="font-display text-lg font-semibold text-brand-ink mb-3">Protein forward</h3>
            <p className="text-sm leading-6 text-brand-ink/80">
              Built on cottage cheese, packed with protein.
            </p>
          </div>
          <div className="rounded-2xl border border-neutral-200/70 bg-white p-6 shadow-[0_1px_0_rgba(0,0,0,0.04)]">
            <h3 className="font-display text-lg font-semibold text-brand-ink mb-3">Elevated flavors</h3>
            <p className="text-sm leading-6 text-brand-ink/80">
      ...
      <Section className="py-2 sm:py-4">
        <h2 className="font-display text-2xl font-semibold tracking-tight text-brand-ink mb-6">How to enjoy</h2>
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          <div className="inline-flex items-center rounded-xl border border-neutral-200 bg-white px-4 py-3 text-sm text-brand-ink shadow-[0_1px_0_rgba(0,0,0,0.03)]">
      ...
      <Section className="py-12 sm:py-16">
        <div className="rounded-2xl border border-neutral-200/70 bg-white p-8 shadow-[0_1px_0_rgba(0,0,0,0.04)]">
          <h3 className="font-display text-xl font-semibold tracking-tight text-brand-ink mb-6">Founder Note</h3>
          <div className="space-y-4 text-brand-ink/80 leading-7">
            <p>
