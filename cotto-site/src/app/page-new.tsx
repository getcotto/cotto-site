  ...
  return (
    <div className="font-sans">
      ...
      <section className="py-24 text-center">
        <h1 className="text-5xl font-extrabold mb-4 text-[color:var(--cotto-red)]">COTTO</h1>
        <h2 className="text-3xl font-bold mb-2">Elevated Cottage Cheese-Based Dips</h2>
        ...
        <div className="grid gap-4 sm:grid-cols-[1fr_auto] sm:items-center">
          <div>
            ...
            <p className="mt-2 text-black/70 max-w-prose">
              We are bringing elevated, protein-forward cottage cheese dips to your favorite
      ...
      <section className="py-16 text-center">
        <h2 className="text-3xl font-bold mb-8">Follow along our journey to launch</h2>
