    ...
    <div className="font-body">
      ...
      <section className="pt-32 pb-48 md:pb-16 px-4 md:px-6 text-center flex flex-col items-center justify-center min-h-screen">
        <div className="w-full max-w-4xl">
          ...
          <h2 className="text-lg md:text-xl font-bold mb-2 font-display text-brand-red italic whitespace-nowrap">Cottage cheese-based dips</h2>
          <h3 className="text-base md:text-lg font-bold mb-2 font-display text-brand-red whitespace-nowrap">High protein. Clean ingredients.</h3>
