  ...
  return (
    <div className="font-body">
      ...
      <section className="pt-32 pb-48 md:pb-16 px-6 text-center">
        <h1 className="text-6xl md:text-7xl font-extrabold mb-3 text-brand-red font-display whitespace-nowrap">COTTO TEST</h1>
        <h2 className="text-base md:text-xl font-bold mb-2 font-display text-brand-red italic whitespace-nowrap">Cottage cheese-based dips</h2>
        <h3 className="text-sm md:text-lg font-bold mb-2 font-display text-brand-red whitespace-nowrap">High protein. Clean ingredients.</h3>
