    ...
    <div className="font-body">
      ...
      <section className="pt-32 pb-48 md:pb-16 px-4 md:px-6 text-center flex flex-col items-center justify-center min-h-screen">
        <div className="w-full max-w-4xl">
          <h1 className="text-6xl md:text-7xl font-extrabold mb-3 text-brand-red font-display whitespace-nowrap">COTTO</h1>
          <h2 className="text-2xl md:text-3xl font-bold mb-2 font-display text-brand-red italic whitespace-nowrap">Cottage cheese-based dips</h2>
          <h3 className="text-xl md:text-2xl font-bold mb-2 font-display text-brand-red whitespace-nowrap">High protein. Clean ingredients.</h3>
