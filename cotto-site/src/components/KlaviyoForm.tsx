        ...
        <div className="mt-4">
          <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
            <input
              ...
              required
              className="flex-1 px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#7c1d1d] focus:border-transparent"
            />
            <button
              type="submit"
              className="px-6 py-3 bg-[#7c1d1d] text-white font-medium rounded-lg hover:opacity-90 transition-opacity"
            >
              Join Waitlist
            </button>
          </form>
